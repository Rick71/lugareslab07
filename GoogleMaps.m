...
- (IBAction)BtnInicio:(id)sender {
    [self performSegueWithIdentifier:@"SegueGoogleMapsToIndex" sender:self];
}

- (IBAction)BtnMapas:(id)sender {
    [self performSegueWithIdentifier:@"SegueGoogleMapsToMapas" sender:self];
}

- (IBAction)BtnLista:(id)sender {
    [self performSegueWithIdentifier:@"SegueGoogleMapsToMuestraDB" sender:self];
}
@end
